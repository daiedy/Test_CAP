...
**Why:** PATTERNS row "Value help from a code list" and `templates/annotations-ui.cds` said "explicit ValueList", while the only real example (`Products.currency_code`) was implicit. Verified with cds-dk 10.0.7 in a scratch compile (see `docs/features/categories-code-list/CONTEXT.md`, "Verified by compilation"). ADR-0011 accepted by the user 2026-09-07 in both parts.
