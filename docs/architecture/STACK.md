...
8. Language of the chat and the briefing: `"env": { "PIPELINE_LANG": "ru" }` in `.claude/settings.local.json` (per machine, gitignored); unset means English for the scripts and the user's language for the chat.
